...
hyperparameters = {
    ...
    "units": [None, 32],  # GRU units
    "dropout": [None, 0.2],  # Dropout rates
}



def GRU_model(model_name, input_shape, units=32, learning_rate=0.01, dropout=None):
    K.clear_session()
