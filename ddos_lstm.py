...
from tensorflow.keras.layers import Input, Dense, Activation, Flatten, Conv2D,LSTM
...
def LSTM_Model(model_name, input_shape, units=32, dropout=0.2, learning_rate=0.01):
    # Initialize the constructor
    K.clear_session()
    model = Sequential(name=model_name)
    
    # Adding LSTM layer with potential regularization
    # if regularization:
    #     reg = tf.keras.regularizers.l2(regularization)  # Applying L2 regularization
    # else:
    #     reg = None
